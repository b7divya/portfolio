        ...
        <div className='about'>
            <div className='about-container'>
                ...
                <div className='about-container-title'>
                    Front-End Developer crafting dynamic, <br /> 
                ...
                <div className='about-container-image'>
                    <img src={Divya} alt="Front-End Developer" />
                </div>
                ...
                <div className='about-container-education'>
                    ...
                    <div className='about-container-education-container'>
                        ...
                        <div className='about-container-education-secondary'>
                            <h3>Secondary Education</h3>
                            <h5>English, Hindi, Maths, Science, Social Studies</h5>
                            <h5>2011-12</h5>
                        </div>
                    </div>
                </div>
